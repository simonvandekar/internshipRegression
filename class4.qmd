...
$$   \text{logit}(p) = \log\left(\frac{p}{1 - p}\right) = \beta_0 + \beta_1 X_1 + \beta_2 X_2 + \ldots + \beta_k X_k
   $$ where: - \$ p \$ is the probability of the outcome (smoking = 1). - \$ X_1, X_2, \ldots, X_k \$ are the predictor variables (age, sex, region). - \$ \beta\_0 \$ is the intercept. - \$ \beta\_1, \beta\_2, \ldots, \beta\_k \$ are the coefficients for the predictors.
